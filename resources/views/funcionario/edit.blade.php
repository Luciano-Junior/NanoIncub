    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{route('funcionario.update', $funcionario->id)}}">
            ...
            <div class="form-row">
                ...
                <input type="text" class="form-control" id="nome" name="nome_completo" value="{{$funcionario->nome_completo}}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                <label for="login">Login</label>
                <input type="text" class="form-control" id="login" name="login" value="{{$funcionario->login}}">
                </div>
                <div class="form-group col-md-4">
